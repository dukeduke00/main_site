...
<html lang="en">
    ...
    <body>
        ...
        <form class=" d-flex flex-column  gap-2 justify-content-center align-items-center" style="margin-top:200px;"  action="models/login.php" method="POST">
            ...
            <button class="btn bg-success">Prijavite se</button>
        </form>
